...
('PED1234567891', CURRENT_TIMESTAMP, 'ENTREGUE', 45.90, NULL, 2, 2),
...
(1, 18.90, 18.90, 1, 4), -- X-Burger (exemplo de pedido misto)

-- Pedido 2 - Maria (Burger House)
(1, 18.90, 18.90, 2, 4), -- X-Burger
(1, 22.90, 22.90, 2, 5), -- X-Bacon
(1, 4.10, 4.10, 2, 6),   -- Batata Frita (ajuste para total fechar 45.90)

-- Pedido 3 - Pedro (Sushi Master)
(1, 45.90, 45.90, 3, 7), -- Combo Sashimi
(1, 32.90, 32.90, 3, 8); -- Hot Roll Salmão


-- DATA.SQL (usuários de teste):
